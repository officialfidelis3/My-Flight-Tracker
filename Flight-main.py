...
if choice == "Home":
    ...
    st.write("This application provides real-time flight tracking and weather updates for passengers.")
    st.write("Our mission is to keep passengers informed and safe during their travels.")

elif choice == "Contact Us":
    st.subheader("Contact Us")
    st.write("For any inquiries, please reach out to us at support@flighttracker.com.")
